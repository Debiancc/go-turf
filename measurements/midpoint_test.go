...
func TestMidPoint(t *testing.T) {
	...
	start1 := features.NewPoint([2]float64{0, 0})
	end1 := features.NewPoint([2]float64{10, 0})
	...
	start2 := features.NewPoint([2]float64{0, 0})
	end2 := features.NewPoint([2]float64{0, 10})
	...
	start3 := features.NewPoint([2]float64{0, 10})
	end3 := features.NewPoint([2]float64{0, 0})
	...
	start4 := features.NewPoint([2]float64{-1, 10})
	end4 := features.NewPoint([2]float64{1, -1})
	...
	start5 := features.NewPoint([2]float64{-5, -1})
	end5 := features.NewPoint([2]float64{5, 10})
	...
	start6 := features.NewPoint([2]float64{22.5, 21.94304553343818})
	end6 := features.NewPoint([2]float64{92.10937499999999, 46.800059446787316})
