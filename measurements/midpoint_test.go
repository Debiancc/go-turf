...
func TestMidPoint(t *testing.T) {
	...
	start1 := features.NewPoint([2]float64{0, 0}, nil, nil)
	end1 := features.NewPoint([2]float64{10, 0}, nil, nil)
	...
	start2 := features.NewPoint([2]float64{0, 0}, nil, nil)
	end2 := features.NewPoint([2]float64{0, 10}, nil, nil)
	...
	start3 := features.NewPoint([2]float64{0, 10}, nil, nil)
	end3 := features.NewPoint([2]float64{0, 0}, nil, nil)
	...
	start4 := features.NewPoint([2]float64{-1, 10}, nil, nil)
	end4 := features.NewPoint([2]float64{1, -1}, nil, nil)
	...
	start5 := features.NewPoint([2]float64{-5, -1}, nil, nil)
	end5 := features.NewPoint([2]float64{5, 10}, nil, nil)
	...
	start6 := features.NewPoint([2]float64{22.5, 21.94304553343818}, nil, nil)
	end6 := features.NewPoint([2]float64{92.10937499999999, 46.800059446787316}, nil, nil)
